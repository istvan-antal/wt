...
function publish(symbolSet) {
	publish.conf = {  // trailing slash expected for dirs
		...
		templateName: "jQ",
		templateVersion: "0.1",
		templateLink: "http://www.istvan-antal.ro/",
                origTemplateLink: "http://www.thebrightlines.com/2010/05/06/new-template-for-jsdoctoolkit-codeview/"
	};
	...
	IO.mkPath((publish.conf.outDir+"symbols/src").split("/"));
        ...
        //theme
        IO.mkPath((publish.conf.outDir+publish.conf.cssDir+'/themes/aristo'));
        IO.mkPath((publish.conf.outDir+publish.conf.cssDir+'/themes/aristo/images'));
	...
	// copy static files
        //theme
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"main.css", publish.conf.outDir+"/"+publish.conf.cssDir);
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"themes/aristo/theme.css", publish.conf.outDir+"/"+publish.conf.cssDir+'themes/aristo/');
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"themes/aristo/images/bg_fallback.png", publish.conf.outDir+"/"+publish.conf.cssDir+'themes/aristo/images/');
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"themes/aristo/images/icon_sprite.png", publish.conf.outDir+"/"+publish.conf.cssDir+'themes/aristo/images/');
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"themes/aristo/images/progress_bar.gif", publish.conf.outDir+"/"+publish.conf.cssDir+'themes/aristo/images/');
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"themes/aristo/images/slider_handles.png", publish.conf.outDir+"/"+publish.conf.cssDir+'themes/aristo/images/');
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"themes/aristo/images/ui-icons_222222_256x240.png", publish.conf.outDir+"/"+publish.conf.cssDir+'themes/aristo/images/');
        IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"themes/aristo/images/ui-icons_454545_256x240.png", publish.conf.outDir+"/"+publish.conf.cssDir+'themes/aristo/images/');
